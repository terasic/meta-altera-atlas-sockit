SUMMARY = "Atlas SoC customization"
DESCRIPTION = "Atlas SoC lighttpd configuration customization to enable cgi, set 404 page, and change serverroot"
...
sed -i '/server.document-root/c server.document-root        = "/usr/share/atlas-soc-101"' $D/etc/lighttpd.conf
